...
class Request {
  ...
  // Downstream Adaptive builds must never install an official FlClash APK: the
  // signatures and application IDs are intentionally different. Updates are
  // delivered only by this downstream build pipeline.
